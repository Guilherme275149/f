...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:minato\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=+11934488829:+55 1193448-8829\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const premium = ["+5511934488829@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
		...
		if (messagesC.includes("bot")){
			...
			switch(command) {
				...
				case 'pika':
					...
					break
					case 'antivirtexx':
			await costum(antivirtexx(), text, tescuk, `Buset Dahh Adahekel🔥`)
			break 
				case 'help1':
				case 'menu1':
                 ...
                 if (!isGroupAdmins) return reply(ind.admin())
					...
					if (args.length < 1) return reply('digite para ativa')
					if ((args[0]) === 'on') {
						if (isAntiVirtex) return reply('grupo anti virtex já está ativo')
						...
						reply('on para ativa,off pra desativa')
					}
					break
					case 'lista':
...
//@minatoYT					
    ...
    break
            ...
            case 'rapL':
				...
				case 'daftar':
					client.updatePresence(from, Presence.composing)
					if (args.length < 1) return reply(`Parameter Salah\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar MINATO|14`)
...
// recursos anime, random @MINATO domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "MINATO"🙄, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do minato:*\n\n https://youtube.com/channel/UCZEtf9AlsC2zsJQwrfW-44w'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
